    ...
    return (
      <div className="card border-rose-500/30 bg-rose-500/5 p-4 text-sm sm:p-5">
        ...
        <p className="mt-1 text-white/60">
          Le compte API-Football a été <span className="text-white/80">suspendu au niveau du compte</span> — ce n'est{" "}
          <span className="text-white/80">pas</span> le quota quotidien, donc ça ne se débloque pas automatiquement après 24 h.
          Cela arrive souvent après un usage trop intensif du plan gratuit.
        </p>
        <ul className="mt-2 list-inside list-disc space-y-0.5 text-xs text-white/50">
          <li>
            Connecte-toi à{" "}
